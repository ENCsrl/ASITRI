...
class PerfilController extends Controller
{
  ...
  // public function index()
   // {
       // $areas_v = Areas::orderBy('id', 'des');

       // $areas_v = Areas::orderBy('nombreArea', 'asc')
    ...
    // public function index(){
    //     $areas = Area::all();
    //     return view('perfiles.creater',['areas'=>'$areas->toArray()']) ;
...
//         $res[3]=$modalidades;
//         $res[4]=$subareas;
//         return view('perfiles.creater', compact('res'));
//     }
