...
@section('content')
   ...
   <h1 align="center">Carreras</h1>
    ...
    <form action="creates" method="POST" id="miForm">
       {{csrf_field()}}
    <!--editad fradev-->
     <!-- Grid row -->
  <!-- <div class="form-row">-->
      ...
      <!-- <div class="col-md-12">-->
          ...
          <!-- <div class="md-form form-group">
               <input type="text" class="form-control" id="nombreEst" required name="titulo" placeholder='Escriba el nombre de la carrera'>
