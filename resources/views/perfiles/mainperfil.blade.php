...
<div class="container">
	<div class="form-row">
		...
		<div class="col-md-6">
                ...
                <input type="text" class="form-control pl-0 rounded-0" id="Search1" type="text" placeholder="Buscar Perfiles...">
                </div>
	    </div>    	
    	...
    	<div class="col-md-3" align="right">
			...
			<button class="btn btn-cyan btn-rounded">
                <a href="/creater"><font color="white" size="3">NUEVO PERFIL</font></a>
			</button>
    	</div>
    </div>
